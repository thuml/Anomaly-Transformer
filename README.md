...
1. Install Python 3.6, PyTorch >= 1.4.0. (Thanks Élise for the contribution in solving the environment, see this [issue](https://github.com/thuml/Anomaly-Transformer/issues/11))
